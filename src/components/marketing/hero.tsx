...
const Hero = () => {
    return (
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
            ...
            <BlurText
                word={"Your ultimate Fully Website\n marketing tool"}
            ...
            <Container delay={0.1}>
                ...
                One platform for all your customer interactions. Seamlessly manage LINE, Facebook,  <span className="hidden sm:inline">and web chat with powerful CRM tools.</span>
                </p>
            </Container>
            <Container delay={0.2}>
